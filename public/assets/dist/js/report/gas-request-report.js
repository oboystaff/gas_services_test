$(document).ready(function () {
    ...
    $('.generate_report').on('click', function(event) {
        ...
        if ($('select[name="report_type"]').val() == 1) {
            ...
            load_data(from_date, to_date, branch_id, community_id, report_type, status);
        } else {
            $('#summary').show();
            $('#details').hide();
            $('#graph').show();
    ...
    function load_data(from_date = '', to_date = '', branch_id = '', community_id = '', report_type = '', status = '') {
        var url = $("input[name='gas-request-report_url']").attr("url");
        ...
        try {
            $('#zero_config').DataTable({
                ...
                columns: [
                    ...
                    {data: 'request_contact', name: 'request_contact'},
                    {data: 'community', name: 'community'},
                    {data: 'branch', name: 'branch'},
                    {data: 'delivery_branch', name: 'delivery_branch'},
                    {data: 'kg', name: 'kg'},
                    {data: 'amount', name: 'amount'},
                    {data: 'status', name: 'status'},
                    {data: 'agent_assigned', name: 'agent_assigned'},
