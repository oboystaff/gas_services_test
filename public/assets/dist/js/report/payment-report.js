$(document).ready(function () {
    ...
    $('.generate_report').on('click', function(event) {
        ...
        if ($('select[name="report_type"]').val() == 1) {
            ...
            load_data(from_date, to_date, branch_id, payment_mode, report_type);
        } else {
            $('#summary').show();
            $('#details').hide();
            $('#graph').show();
    ...
    function load_data(from_date = '', to_date = '', branch_id = '', payment_mode = '', report_type = '') {
        ...
        try {
            $('#zero_config').DataTable({
                ...
                columns: [
                    ...
                    {data: 'withholding_tax_amount', name: 'withholding_tax_amount'},
                ...
                footerCallback: function (row, data, start, end, display) {
                    ...
                    $('#withholding_total').html(format_money(withholding_total));
                }
            });
        } catch (err) {
