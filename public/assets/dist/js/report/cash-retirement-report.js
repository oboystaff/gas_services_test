        ...
        try {
            $('#zero_config').DataTable({
                ...
                columns: [
                    ...
                    {data: 'branch_manager', name: 'branch_manager'},
                    {data: 'total_sales', name: 'total_sales'},
                    {data: 'sales_date', name: 'sales_date'},
                    {data: 'total_retired', name: 'total_retired'},
                    {data: 'status', name: 'status'},
                    {data: 'branch', name: 'branch'},
                    {data: 'date_retired', name: 'date_retired'}
                ],
                dom: 'lBfrtip',
                ...
                footerCallback: function (row, data, start, end, display) {
                    ...
                    // Update status DIV
                    $('#title').html('Total');
                    $('#total_sales').html(format_money(total_sales));
                    $('#total_retired').html(format_money(total_retired));
                }
            });
        } catch (err) {
