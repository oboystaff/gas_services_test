                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center" style="margin-bottom: 20px;">
                            <h5 class="card-title">Reverse Gas Request</h5>
                        ...
                        <form method="POST" action="{{ route('gas-requests.reverseRequest', $gasRequest) }}">
                            @csrf
                            ...
                            <div class="d-flex justify-content-end" style="margin-top:20px;">
                                <button type="submit" class="btn btn-primary" style="width:180px">
                                    <i class="fa fa-paper-plane" aria-hidden="true"></i> Reverse Request
                                </button>
                            </div>
                        </form>
                    </div>
