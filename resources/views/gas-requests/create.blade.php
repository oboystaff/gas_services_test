            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('gas-requests.store') }}">
                            @csrf
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mt-3">
                                            ...
                                            <input type="text"
                                                ...
                                                name="customer_id" id="customer_id" placeholder="Customer ID" readonly />
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mt-3">
                                            ...
                                            <select
                                                ...
                                                name="community_id">
                                                <option disabled selected>Select Customer Branch</option>
