    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <input type="hidden" name="invoice-report_url" url="{{ route('invoice-reports.index') }}">

                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center" style="margin-bottom: 10px;">
                            <h5 class="card-title">View Payment Report</h5>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mt-3">
                                    ...
                                    <select class="form-control default-select @error('payment_mode') is-invalid @enderror"
                                        name="payment_mode">
...
@section('page-scripts')
    ...
    <script src="{{ asset('assets/dist/js/report/payment-report.js?t=' . time()) }}"></script>
