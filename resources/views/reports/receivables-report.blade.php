    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <input type="hidden" name="receivables-report_url" url="{{ route('receivables-reports.index') }}">

                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center" style="margin-bottom: 10px;">
                            <h5 class="card-title">View Receivables Report</h5>
                        </div>
...
@section('page-scripts')
    ...
    <script src="{{ asset('assets/dist/js/report/receivables-report.js?t=' . time()) }}"></script>
