    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <input type="hidden" name="gas-request-report_url" url="{{ route('gas-request-reports.index') }}">

                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center" style="margin-bottom: 10px;">
                            <h5 class="card-title">View Gas Request Report</h5>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mt-3">
                                    ...
                                    <select class="form-control default-select @error('status') is-invalid @enderror"
                                        ...
                                        <option value="Gas Delivered">Gas Delivered</option>
...
@section('page-scripts')
    ...
    <script src="{{ asset('assets/dist/js/report/gas-request-report.js?t=' . time()) }}"></script>
