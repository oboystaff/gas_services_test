                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center" style="margin-bottom: 30px;">
                            <h5 class="card-title">View Communities</h5>

                            <a href="{{ route('communities.create') }}" type="button" class="btn btn-primary">
                                ...
                                <tbody>
                                    @foreach ($communities as $index => $community)
                                        <tr>
                                            ...
                                            <td>{{ $community->service_charge ?? 'N/A' }}</td>
                                            <td>{{ $community->createdBy->name ?? 'N/A' }}</td>
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <div class="py-2">
                                                            <a class="dropdown-item"
                                                                href="{{ route('communities.show', $community) }}">View
                                                            </a>
                                                            <a class="dropdown-item"
                                                                href="{{ route('communities.edit', $community) }}">Edit
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
