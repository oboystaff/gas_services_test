                                ...
                                <div class="col-md-6">
                                    <div class="form-group mt-3">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                            name="name" placeholder="Driver Name" value="{{ $driver->name }}" />
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mt-3">
                                        ...
                                        <select
                                            ...
                                            <option value="A" {{ $driver->license_type == 'A' ? 'selected' : '' }}>A
                                            </option>
                                            <option value="B" {{ $driver->license_type == 'B' ? 'selected' : '' }}>B
                                            </option>
                                            <option value="C" {{ $driver->license_type == 'C' ? 'selected' : '' }}>C
                                            </option>
                                            <option value="D" {{ $driver->license_type == 'D' ? 'selected' : '' }}>D
                                            </option>
                                            <option value="E" {{ $driver->license_type == 'E' ? 'selected' : '' }}>E
                                            </option>
                                            <option value="F" {{ $driver->license_type == 'F' ? 'selected' : '' }}>F
                                            </option>
                                        </select>
